...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  ...
  importAll(__webpack_require__("./src/assets/images/weather-photos sync \\.jpg$"));
  // console.log(imgObj);
...
/***/ "./src/components/main/calendar.js":
/*!*****************************************!*\
  !*** ./src/components/main/calendar.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  const container = document.createElement('div');
  container.textContent = 'calendar';
  return container;
})());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  ...
  const updateClock = () => {
    ...
    time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, 'h:mm bbb');
  };
  updateClock();
...
/* harmony import */ var _functions_hideOnOutsideClick__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../functions/hideOnOutsideClick */ "./src/functions/hideOnOutsideClick.js");
...
const locationSearch = (() => {
  ...
  const autocomplete = (() => {
    ...
    const showResults = list => {
      ...
      (0,_functions_hideOnOutsideClick__WEBPACK_IMPORTED_MODULE_3__["default"])(ul, '.autocomplete-list');
...
/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo */ "./src/components/main/todo.js");
/* harmony import */ var _calendar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calendar */ "./src/components/main/calendar.js");
/* harmony import */ var _clock__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./clock */ "./src/components/main/clock.js");
/* harmony import */ var _radio__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./radio */ "./src/components/main/radio.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  ...
  container.append(_locationInput__WEBPACK_IMPORTED_MODULE_1__["default"].container, _clock__WEBPACK_IMPORTED_MODULE_4__["default"], _weatherDisplay__WEBPACK_IMPORTED_MODULE_0__["default"].container
  // todoList,
  // calendar,
  // radio,
  );
...
/* harmony import */ var _functions_save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../functions/save */ "./src/functions/save.js");
...
const weatherDisplay = (() => {
  ...
  const unitSlider = (() => {
    ...
    if ((0,_functions_load__WEBPACK_IMPORTED_MODULE_2__["default"])('units')) {
      console.log((0,_functions_load__WEBPACK_IMPORTED_MODULE_2__["default"])('units'));
      console.log((0,_functions_load__WEBPACK_IMPORTED_MODULE_2__["default"])('units'));
      input.checked = (0,_functions_load__WEBPACK_IMPORTED_MODULE_2__["default"])('units');
    } else (0,_functions_save__WEBPACK_IMPORTED_MODULE_3__["default"])('units', input.checked);
  ...
  container.append(locationOuput, currentTempOutput, hiLo, weatherImgOutput, descriptionOutput, unitSlider.label);
  return {
    container,
    setLocationOutput,
    setCurrentTempOutput,
...
const displayData = response => {
  ...
  weatherDisplay.unitSlider.label.addEventListener('click', () => {
    showWeather();
    (0,_functions_save__WEBPACK_IMPORTED_MODULE_3__["default"])('units', weatherDisplay.unitSlider.getScale());
  });
  showWeather();
};
...
const getWeather = async data => {
  ...
  _components_main_weatherDisplay__WEBPACK_IMPORTED_MODULE_1__["default"].clearOutputs();
  // Process JSON data
  try {
    const res = await fetch(url);
    const json = await res.json();
...
/***/ "./src/functions/hideOnOutsideClick.js":
/*!*********************************************!*\
  !*** ./src/functions/hideOnOutsideClick.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face {\r\n  font-family: 'Quentin';\r\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\r\n}\r\n@font-face {\r\n  font-family: 'Modern Sans';\r\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\r\n  font-weight: light;\r\n}\r\n\r\n:root {\r\n  --heading: 'Quentin';\r\n  --body: 'Modern Sans';\r\n}\r\n\r\n*, *::after, *::before {\r\n  box-sizing: border-box;\r\n}\r\nbody {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  font-family: var(--body);\r\n  min-height: 100vh;\r\n  width: 100%;\r\n}\r\n\r\n.background {\r\n  background-color: #DAEBF2;\r\n  background-size: cover;\r\n  position: fixed;\r\n  margin: 0;\r\n  padding: 0;\r\n  width: 100vw;\r\n  min-height: 100vh;\r\n  z-index: -1;\r\n}\r\n\r\nh1, h2, h3 {\r\n  margin:0;\r\n}\r\n\r\nheader {\r\n  background-color: rgba(255, 255, 255,.2);\r\n  /* border:solid 1px rgba(255, 255, 255,.2); */\r\n  box-shadow: 0 1px 5px rgba(0,0,0,.2);\r\n  backdrop-filter: blur(5px);\r\n  margin: 0;\r\n  width: 100%;\r\n  padding: 20px;\r\n  font-family:var(--heading);\r\n}\r\n\r\nmain {\r\n  flex:auto;\r\n  text-align: center;\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: start;\r\n  padding: 20px;\r\n  margin:20px;\r\n  position: relative;\r\n  background-color: rgba(255,255,255,.2);\r\n  box-shadow: 1px 1px 10px rgba(0,0,0,.1);\r\n  backdrop-filter: blur(5px);\r\n  /* border:solid 1px rgba(255, 255, 255,.2); */\r\n  border-radius: 5px;\r\n}\r\n\r\n.location-input {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-self: start;\r\n}\r\n.location-input input {\r\n  border:none;\r\n  padding:4px 5px;\r\n  background-color: rgba(255, 255, 255,.95);\r\n  font-size: 1.2rem;\r\n  height:35px;\r\n  border:solid 1px transparent;\r\n  transition: .1s;\r\n  flex:auto;\r\n}\r\n.location-input input:focus {\r\n  border:solid 1px #D0D0D7;\r\n  outline:none;\r\n}\r\n.location-search button {\r\n  border:none;\r\n  height: 35px;\r\n  min-width:50px;\r\n  padding:5px;\r\n  transition: .1s;\r\n}\r\n\r\nbutton.use-location {\r\n  margin:10px;\r\n  padding:5px 10px;\r\n}\r\n\r\n.autocomplete-container {\r\n  box-shadow: 1px 1px 10px #0000001a;\r\n  border-radius: 0 0 5px 5px;\r\n  overflow: auto;\r\n  position: absolute;\r\n  display: none;\r\n}\r\n.autocomplete-list {\r\n  margin: 0;\r\n  padding: 0;\r\n  text-align: left;\r\n  background-color: rgba(255, 255, 255,.95);\r\n  list-style: none;\r\n  z-index:9999999;\r\n  width: 100%;\r\n}\r\n.autocomplete-item {\r\n  padding: 5px 10px;\r\n  margin: 0;\r\n  transition: .2s;\r\n}\r\n.autocomplete-item:not(.no-hover):hover {\r\n  background-color: rgba(0,0,0,.08);\r\n  cursor: pointer;\r\n}\r\n\r\n.clock {\r\n  padding:20px;\r\n  font-size:1.5rem;\r\n}\r\n\r\n.weather-display {\r\n  flex:1;\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n.weather-display .location {\r\n  font-family: var(--heading);\r\n  font-size:2rem;\r\n  text-transform: lowercase;\r\n}\r\n.current-temp {\r\n  font-size:4rem;\r\n}\r\n.weather-img {\r\n  width:100px;\r\n}\r\n\r\n.unit-slider {\r\n  position: relative;\r\n  cursor: pointer;\r\n}\r\n\r\n.unit-slider input {\r\n  position: absolute;\r\n  width: 0;\r\n  height: 0;\r\n  opacity: 0;\r\n}\r\n\r\n.unit-slider .slider {\r\n  /* border: solid 1px; */\r\n  padding: 5px;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  width:150px;\r\n  height: 27px;\r\n}\r\n\r\n.unit-slider .slider::before {\r\n  content: '';\r\n  position: absolute;\r\n  left:-2px;\r\n  top:0;\r\n  display: block;\r\n  width: 60px;\r\n  transition: .2s;\r\n  border: solid 1px rgba(0,0, 0, .2);\r\n  height: 100%;\r\n  filter: drop-shadow(2px 2px 2px rgba(0,0,0,1));\r\n}\r\n.unit-slider input:checked + .slider::before {\r\n  width:90px;\r\n  transform: translateX(65px);\r\n}\r\n.slider .celsius {\r\n  opacity: 1;\r\n  transition: .2s;\r\n}\r\n.slider .fahrenheit {\r\n  opacity: .2;\r\n  transition: .2s;\r\n}\r\n.unit-slider input:checked + .slider .celsius {\r\n  opacity: .2;\r\n}\r\n.unit-slider input:checked + .slider .fahrenheit {\r\n  opacity: 1;\r\n}\r\n\r\ndialog.custom-modal {\r\n  border: none;\r\n}\r\n\r\nfooter {\r\n  width: 100%;\r\n  margin:0;\r\n  padding: 40px 30px;\r\n  background-color: rgba(255,255,255, .2);\r\n  backdrop-filter: blur(5px);\r\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,4CAAgC;AAClC;AACA;EACE,0BAA0B;EAC1B,4CAAyC;EACzC,kBAAkB;AACpB;;AAEA;EACE,oBAAoB;EACpB,qBAAqB;AACvB;;AAEA;EACE,sBAAsB;AACxB;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,wBAAwB;EACxB,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,sBAAsB;EACtB,eAAe;EACf,SAAS;EACT,UAAU;EACV,YAAY;EACZ,iBAAiB;EACjB,WAAW;AACb;;AAEA;EACE,QAAQ;AACV;;AAEA;EACE,wCAAwC;EACxC,6CAA6C;EAC7C,oCAAoC;EACpC,0BAA0B;EAC1B,SAAS;EACT,WAAW;EACX,aAAa;EACb,0BAA0B;AAC5B;;AAEA;EACE,SAAS;EACT,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,sBAAsB;EACtB,aAAa;EACb,WAAW;EACX,kBAAkB;EAClB,sCAAsC;EACtC,uCAAuC;EACvC,0BAA0B;EAC1B,6CAA6C;EAC7C,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;AACrB;AACA;EACE,WAAW;EACX,eAAe;EACf,yCAAyC;EACzC,iBAAiB;EACjB,WAAW;EACX,4BAA4B;EAC5B,eAAe;EACf,SAAS;AACX;AACA;EACE,wBAAwB;EACxB,YAAY;AACd;AACA;EACE,WAAW;EACX,YAAY;EACZ,cAAc;EACd,WAAW;EACX,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,gBAAgB;AAClB;;AAEA;EACE,kCAAkC;EAClC,0BAA0B;EAC1B,cAAc;EACd,kBAAkB;EAClB,aAAa;AACf;AACA;EACE,SAAS;EACT,UAAU;EACV,gBAAgB;EAChB,yCAAyC;EACzC,gBAAgB;EAChB,eAAe;EACf,WAAW;AACb;AACA;EACE,iBAAiB;EACjB,SAAS;EACT,eAAe;AACjB;AACA;EACE,iCAAiC;EACjC,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,MAAM;EACN,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;AACzB;AACA;EACE,2BAA2B;EAC3B,cAAc;EACd,yBAAyB;AAC3B;AACA;EACE,cAAc;AAChB;AACA;EACE,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,uBAAuB;EACvB,YAAY;EACZ,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,SAAS;EACT,KAAK;EACL,cAAc;EACd,WAAW;EACX,eAAe;EACf,kCAAkC;EAClC,YAAY;EACZ,8CAA8C;AAChD;AACA;EACE,UAAU;EACV,2BAA2B;AAC7B;AACA;EACE,UAAU;EACV,eAAe;AACjB;AACA;EACE,WAAW;EACX,eAAe;AACjB;AACA;EACE,WAAW;AACb;AACA;EACE,UAAU;AACZ;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,QAAQ;EACR,kBAAkB;EAClB,uCAAuC;EACvC,0BAA0B;AAC5B","sourcesContent":["@font-face {\r\n  font-family: 'Quentin';\r\n  src: url('./assets/Quentin.otf');\r\n}\r\n@font-face {\r\n  font-family: 'Modern Sans';\r\n  src: url('./assets/ModernSans-Light.otf');\r\n  font-weight: light;\r\n}\r\n\r\n:root {\r\n  --heading: 'Quentin';\r\n  --body: 'Modern Sans';\r\n}\r\n\r\n*, *::after, *::before {\r\n  box-sizing: border-box;\r\n}\r\nbody {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  font-family: var(--body);\r\n  min-height: 100vh;\r\n  width: 100%;\r\n}\r\n\r\n.background {\r\n  background-color: #DAEBF2;\r\n  background-size: cover;\r\n  position: fixed;\r\n  margin: 0;\r\n  padding: 0;\r\n  width: 100vw;\r\n  min-height: 100vh;\r\n  z-index: -1;\r\n}\r\n\r\nh1, h2, h3 {\r\n  margin:0;\r\n}\r\n\r\nheader {\r\n  background-color: rgba(255, 255, 255,.2);\r\n  /* border:solid 1px rgba(255, 255, 255,.2); */\r\n  box-shadow: 0 1px 5px rgba(0,0,0,.2);\r\n  backdrop-filter: blur(5px);\r\n  margin: 0;\r\n  width: 100%;\r\n  padding: 20px;\r\n  font-family:var(--heading);\r\n}\r\n\r\nmain {\r\n  flex:auto;\r\n  text-align: center;\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: start;\r\n  padding: 20px;\r\n  margin:20px;\r\n  position: relative;\r\n  background-color: rgba(255,255,255,.2);\r\n  box-shadow: 1px 1px 10px rgba(0,0,0,.1);\r\n  backdrop-filter: blur(5px);\r\n  /* border:solid 1px rgba(255, 255, 255,.2); */\r\n  border-radius: 5px;\r\n}\r\n\r\n.location-input {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-self: start;\r\n}\r\n.location-input input {\r\n  border:none;\r\n  padding:4px 5px;\r\n  background-color: rgba(255, 255, 255,.95);\r\n  font-size: 1.2rem;\r\n  height:35px;\r\n  border:solid 1px transparent;\r\n  transition: .1s;\r\n  flex:auto;\r\n}\r\n.location-input input:focus {\r\n  border:solid 1px #D0D0D7;\r\n  outline:none;\r\n}\r\n.location-search button {\r\n  border:none;\r\n  height: 35px;\r\n  min-width:50px;\r\n  padding:5px;\r\n  transition: .1s;\r\n}\r\n\r\nbutton.use-location {\r\n  margin:10px;\r\n  padding:5px 10px;\r\n}\r\n\r\n.autocomplete-container {\r\n  box-shadow: 1px 1px 10px #0000001a;\r\n  border-radius: 0 0 5px 5px;\r\n  overflow: auto;\r\n  position: absolute;\r\n  display: none;\r\n}\r\n.autocomplete-list {\r\n  margin: 0;\r\n  padding: 0;\r\n  text-align: left;\r\n  background-color: rgba(255, 255, 255,.95);\r\n  list-style: none;\r\n  z-index:9999999;\r\n  width: 100%;\r\n}\r\n.autocomplete-item {\r\n  padding: 5px 10px;\r\n  margin: 0;\r\n  transition: .2s;\r\n}\r\n.autocomplete-item:not(.no-hover):hover {\r\n  background-color: rgba(0,0,0,.08);\r\n  cursor: pointer;\r\n}\r\n\r\n.clock {\r\n  padding:20px;\r\n  font-size:1.5rem;\r\n}\r\n\r\n.weather-display {\r\n  flex:1;\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n.weather-display .location {\r\n  font-family: var(--heading);\r\n  font-size:2rem;\r\n  text-transform: lowercase;\r\n}\r\n.current-temp {\r\n  font-size:4rem;\r\n}\r\n.weather-img {\r\n  width:100px;\r\n}\r\n\r\n.unit-slider {\r\n  position: relative;\r\n  cursor: pointer;\r\n}\r\n\r\n.unit-slider input {\r\n  position: absolute;\r\n  width: 0;\r\n  height: 0;\r\n  opacity: 0;\r\n}\r\n\r\n.unit-slider .slider {\r\n  /* border: solid 1px; */\r\n  padding: 5px;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  width:150px;\r\n  height: 27px;\r\n}\r\n\r\n.unit-slider .slider::before {\r\n  content: '';\r\n  position: absolute;\r\n  left:-2px;\r\n  top:0;\r\n  display: block;\r\n  width: 60px;\r\n  transition: .2s;\r\n  border: solid 1px rgba(0,0, 0, .2);\r\n  height: 100%;\r\n  filter: drop-shadow(2px 2px 2px rgba(0,0,0,1));\r\n}\r\n.unit-slider input:checked + .slider::before {\r\n  width:90px;\r\n  transform: translateX(65px);\r\n}\r\n.slider .celsius {\r\n  opacity: 1;\r\n  transition: .2s;\r\n}\r\n.slider .fahrenheit {\r\n  opacity: .2;\r\n  transition: .2s;\r\n}\r\n.unit-slider input:checked + .slider .celsius {\r\n  opacity: .2;\r\n}\r\n.unit-slider input:checked + .slider .fahrenheit {\r\n  opacity: 1;\r\n}\r\n\r\ndialog.custom-modal {\r\n  border: none;\r\n}\r\n\r\nfooter {\r\n  width: 100%;\r\n  margin:0;\r\n  padding: 40px 30px;\r\n  background-color: rgba(255,255,255, .2);\r\n  backdrop-filter: blur(5px);\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
