...
const autocomplete = (() => {
  ...
  const showResults = list => {
    ...
    list.forEach(item => {
      ...
      const string = `${item.name},${item.state ? ` ${item.state},` : ''} ${item.country}`;
...
const getWeather = async data => {
  if (!(data !== null && data !== void 0 && data.lat) || !(data !== null && data !== void 0 && data.lon) || !data) {
...
const displayData = json => {
  ...
  locationOuput.innerHTML = `${query.name}, <small>${query.state ? query.state : query.country}</small>`;
...
const clock = (() => {
  ...
  const updateClock = () => {
    ...
    hours.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, 'h');
    minutes.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, 'mm');
    amPM.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, 'b..bbb');
    date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(today, 'PPPP');
  };
  updateClock();
